<x-app-layout>
    <div class="max-w-7xl mx-auto bg-white shadow-md rounded-lg p-6 my-2">
        <h2 class="text-2xl font-bold text-[#401457]">Add New Service</h2>
        <form action="{{ route('servicelist.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            @csrf
            ...
            <div class="w-full grid grid-cols-1 md:grid-cols-3 gap-4">
                <div class="p-0 space-y-4">
                    ...
                    <div>
                        ...
                        <input value="{{ old('full_title.en') }}" type="text" name="full_title[en]"
                            id="full_title_en"
                            class="mt-1 block w-full p-2 border rounded-md focus:ring-[#401457] focus:border-[#401457] text-[#401457] text-sm">
                    ...
                    <div>
                        ...
                        <textarea name="content_display[en]" id="content_display_en" rows="4"
                            class="mt-1 block w-full p-2 border rounded-md text-[#401457] text-sm">{{ old('content_display.en') }}</textarea>
                ...
                <div class="p-0 space-y-4">
                    ...
                    <div>
                        ...
                        <input value="{{ old('full_title.kh') }}" type="text" name="full_title[kh]"
                            id="full_title_kh"
                            class="mt-1 block w-full p-2 border rounded-md focus:ring-[#401457] focus:border-[#401457] text-[#401457] text-sm">
                    ...
                    <div>
                        ...
                        <textarea name="content_display[kh]" id="content_display_kh" rows="4"
                            class="mt-1 block w-full p-2 border rounded-md text-[#401457] text-sm">{{ old('content_display.kh') }}</textarea>
                ...
                <div class="p-0 space-y-4">
                    ...
                    <div>
                        ...
                        <input value="{{ old('full_title.ch') }}" type="text" name="full_title[ch]"
                            id="full_title_ch"
                            class="mt-1 block w-full p-2 border rounded-md focus:ring-[#401457] focus:border-[#401457] text-[#401457] text-sm">
                    ...
                    <div>
                        ...
                        <textarea name="content_display[ch]" id="content_display_ch" rows="4"
                            class="mt-1 block w-full p-2 border rounded-md text-[#401457] text-sm">{{ old('content_display.ch') }}</textarea>
            ...
            <div class="w-full grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <label for="dropzone-icon" id="drop-area-icon"
                        ...
                        <div id="icon-preview"
                            ...
                            <svg class="w-8 h-8 mb-4 text-[#000]" ...>...</svg>
                            <p class="mb-2 text-[12px] sm:text-[14px] text-[#000]">
                                <span class="font-semibold">Click to upload</span> or drag and drop
                            </p>
                            <p class="text-xs text-[#000]">SVG, PNG, JPG or GIF (MAX. 5MB)</p>
                        </div>
                        <input id="dropzone-icon" type="file" class="hidden" name="icon" accept="image/*"
                            onchange="uploadIcon(event)" />
                    </label>
