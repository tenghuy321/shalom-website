            ...
            <div class="w-full grid grid-cols-1 md:grid-cols-3 gap-4">
                <div class="p-0 space-y-4">
                    ...
                    <div>
                        ...
                        <input value="{{ old('title.en', $hero->title['en'] ?? '') }}" type="text" name="title[en]"
                    ...
                    @if (!empty($hero->content['en']))
                        <div>
                            ...
                            <textarea name="content[en]" id="content_en" rows="6"
                                class="mt-1 block w-full p-2 border rounded-md text-[#401457] text-[12px]">{{ old('content.en', $hero->content['en'] ?? '') }}</textarea>
                ...
                <div class="p-0 space-y-4">
                    ...
                    <div>
                        ...
                        <input value="{{ old('title.kh', $hero->title['kh'] ?? '') }}" type="text" name="title[kh]"
                    ...
                    @if (!empty($hero->content['kh']))
                        <div>
                            ...
                            <textarea name="content[kh]" id="content_kh" rows="6"
                                class="mt-1 block w-full p-2 border rounded-md text-[#401457] text-[12px]">{{ old('content.kh', $hero->content['kh'] ?? '') }}</textarea>
                ...
                <div class="p-0 space-y-4">
                    ...
                    <div>
                        ...
                        <input value="{{ old('title.ch', $hero->title['ch'] ?? '') }}" type="text" name="title[ch]"
                    ...
                    @if (!empty($hero->content['ch']))
                        <div>
                            ...
                            <textarea name="content[ch]" id="content_ch" rows="6"
                                class="mt-1 block w-full p-2 border rounded-md text-[#401457] text-[12px]">{{ old('content.ch', $hero->content['ch'] ?? '') }}</textarea>
            ...
            <div class="w-full grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                @if (!empty($hero->icon))
                    <div>
                        ...
                        <label for="dropzone-icon{{ $hero->id }}" id="drop-area-icon"
                            class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50">
                            <div id="icon-preview" style="background-image: url({{ asset($hero->icon) }})"
                            ...
                            <input id="dropzone-icon{{ $hero->id }}" type="file" class="hidden" name="icon"
                ...
                @if (!empty($hero->image))
                    <div>
                        ...
                        <label for="dropzone-file{{ $hero->id }}" id="drop-area"
                            ...
                            <input id="dropzone-file{{ $hero->id }}" type="file" class="hidden" name="image"
